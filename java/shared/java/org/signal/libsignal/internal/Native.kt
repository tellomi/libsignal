...
internal object Native {
  ...
  public external fun Aes256Ctr32_New(
    key: ByteArray,
    nonce: ByteArray,
    initialCtr: Int,
  ): ObjectHandle
  ...
  @JvmStatic
  public external fun Aes256Ctr32_Process(
    ctr: ObjectHandle,
    data: ByteArray,
    offset: Int,
    length: Int,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun Aes256GcmDecryption_New(
    key: ByteArray,
    nonce: ByteArray,
  ...
  @JvmStatic
  public external fun Aes256GcmDecryption_Update(
    gcm: ObjectHandle,
    data: ByteArray,
    offset: Int,
    length: Int,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun Aes256GcmDecryption_VerifyTag(
    gcm: ObjectHandle,
    tag: ByteArray,
  ): Boolean
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun Aes256GcmEncryption_New(
    key: ByteArray,
    nonce: ByteArray,
    associatedData: ByteArray,
  ): ObjectHandle
  ...
  @JvmStatic
  public external fun Aes256GcmEncryption_Update(
    gcm: ObjectHandle,
    data: ByteArray,
    offset: Int,
    length: Int,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun Aes256GcmSiv_Decrypt(
    aesGcmSiv: ObjectHandle,
    ctext: ByteArray,
    nonce: ByteArray,
    associatedData: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  public external fun AuthenticatedChatConnection_clear_push_token(
    asyncRuntime: ObjectHandle,
    chat: SimpleOwner,
  ): CompletableFuture<Void?>

  @JvmStatic
  public external fun AuthenticatedChatConnection_clear_registration_lock(
    asyncRuntime: ObjectHandle,
    chat: SimpleOwner,
  ): CompletableFuture<Void?>
  ...
  @JvmStatic
  public external fun AuthenticatedChatConnection_delete_username_link(
    asyncRuntime: ObjectHandle,
    chat: SimpleOwner,
  ): CompletableFuture<Void?>

  @JvmStatic
  public external fun AuthenticatedChatConnection_disconnect(
    asyncRuntime: ObjectHandle,
    chat: ObjectHandle,
  ): CompletableFuture<Void?>
  ...
  public external fun AuthenticatedChatConnection_reserve_username_hash(
    asyncRuntime: ObjectHandle,
    chat: SimpleOwner,
    usernameHashes: Array<*>,
  ): CompletableFuture<ByteArray>

  @JvmStatic
  public external fun AuthenticatedChatConnection_send(
    asyncRuntime: ObjectHandle,
    chat: ObjectHandle,
    httpRequest: ObjectHandle,
    timeoutMillis: Int,
  ): CompletableFuture<Object>

  @JvmStatic
  public external fun AuthenticatedChatConnection_send_message_java(
    asyncRuntime: ObjectHandle,
    chat: ObjectHandle,
  ...
  @JvmStatic
  public external fun AuthenticatedChatConnection_set_discoverable_by_phone_number(
    asyncRuntime: ObjectHandle,
    chat: SimpleOwner,
  ...
  @JvmStatic
  public external fun AuthenticatedChatConnection_set_registration_lock(
    asyncRuntime: ObjectHandle,
    chat: SimpleOwner,
    svrKey: ByteArray,
  ): CompletableFuture<Void?>
  ...
  @JvmStatic
  public external fun AuthenticatedChatConnection_set_registration_recovery_password(
    asyncRuntime: ObjectHandle,
    chat: SimpleOwner,
    svrKey: ByteArray,
  ): CompletableFuture<Void?>
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun AvatarUploadCredentialPresentation_Verify(
    presentationBytes: ByteArray,
    currentTime: Long,
    serverParamsBytes: ByteArray,
  ): Unit
  ...
  @JvmStatic
  public external fun AvatarUploadCredentialRequestContext_New(
    aci: ByteArray,
    zkCredentialKeyPairBytes: ByteArray,
    rotationId: Long,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun AvatarUploadCredentialRequestContext_ReceiveResponse(
    contextBytes: ByteArray,
    responseBytes: ByteArray,
    currentTime: Long,
    paramsBytes: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun AvatarUploadCredentialRequest_IssueDeterministic(
    requestBytes: ByteArray,
    aci: ByteArray,
    zkCredentialKeyPubBytes: ByteArray,
    rotationId: Long,
    redemptionTime: Long,
    paramsBytes: ByteArray,
    randomness: ByteArray,
  ...
  @JvmStatic
  public external fun AvatarUploadCredential_PresentDeterministic(
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun BackupAuthCredentialPresentation_Verify(
    presentationBytes: ByteArray,
    now: Long,
    serverParamsBytes: ByteArray,
  ): Unit
  ...
  @JvmStatic
  public external fun BackupAuthCredentialRequestContext_New(
    backupKey: ByteArray,
    uuid: UUID,
  ): ByteArray
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun BackupAuthCredentialRequestContext_ReceiveResponse(
    contextBytes: ByteArray,
    responseBytes: ByteArray,
    expectedRedemptionTime: Long,
    paramsBytes: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  public external fun BackupAuthCredentialRequest_IssueDeterministic(
    requestBytes: ByteArray,
    redemptionTime: Long,
    backupLevel: Int,
    credentialType: Int,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun BackupAuthCredential_PresentDeterministic(
    credentialBytes: ByteArray,
    serverParamsBytes: ByteArray,
    randomness: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun BackupJsonExporter_ExportFrames(
    exporter: ObjectHandle,
    frames: ByteArray,
  ): Array<Object>
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun BackupJsonExporter_New(
    backupInfo: ByteArray,
    shouldValidate: Boolean,
  ): ObjectHandle

  @JvmStatic
  public external fun BackupKey_DeriveBackupId(
    backupKey: ByteArray,
    aci: ByteArray,
  ): ByteArray

  @JvmStatic
  public external fun BackupKey_DeriveEcKey(
    backupKey: ByteArray,
    aci: ByteArray,
  ): ObjectHandle
  ...
  @JvmStatic
  public external fun BackupKey_DeriveMediaEncryptionKey(
    backupKey: ByteArray,
    mediaId: ByteArray,
  ): ByteArray

  @JvmStatic
  public external fun BackupKey_DeriveMediaId(
    backupKey: ByteArray,
    mediaName: String,
  ): ByteArray

  @JvmStatic
  public external fun BackupKey_DeriveThumbnailTransitEncryptionKey(
    backupKey: ByteArray,
    mediaId: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  public external fun BridgedStringMap_insert(
    map: ObjectHandle,
    key: String,
    value: String,
  ): Unit
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun CallLinkAuthCredentialPresentation_Verify(
    presentationBytes: ByteArray,
    now: Long,
    serverParamsBytes: ByteArray,
    callLinkParamsBytes: ByteArray,
  ): Unit
  ...
  @JvmStatic
  public external fun CallLinkAuthCredentialResponse_IssueDeterministic(
    userId: ByteArray,
    redemptionTime: Long,
    paramsBytes: ByteArray,
    randomness: ByteArray,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun CallLinkAuthCredentialResponse_Receive(
    responseBytes: ByteArray,
    userId: ByteArray,
    redemptionTime: Long,
    paramsBytes: ByteArray,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun CallLinkAuthCredential_PresentDeterministic(
    credentialBytes: ByteArray,
    userId: ByteArray,
    redemptionTime: Long,
    serverParamsBytes: ByteArray,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun CallLinkSecretParams_DecryptUserId(
    paramsBytes: ByteArray,
    userId: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  public external fun CallLinkSecretParams_EncryptUserId(
    paramsBytes: ByteArray,
    userId: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun Cds2ClientState_New(
    mrenclave: ByteArray,
    attestationMsg: ByteArray,
  ...
  @JvmStatic
  public external fun CdsiLookup_complete(
    asyncRuntime: ObjectHandle,
    lookup: ObjectHandle,
  ): CompletableFuture<Object>

  @JvmStatic
  public external fun CdsiLookup_new(
    asyncRuntime: ObjectHandle,
    connectionManager: ObjectHandle,
    username: String,
    password: String,
  ...
  @JvmStatic
  public external fun ConnectionManager_new(
    environment: Int,
    userAgent: String,
  ...
  @JvmStatic
  public external fun ConnectionManager_set_censorship_circumvention_enabled(
    connectionManager: ObjectHandle,
    enabled: Boolean,
  ): Unit
  ...
  @JvmStatic
  public external fun ConnectionManager_set_proxy(
    connectionManager: ObjectHandle,
    proxy: ObjectHandle,
  ): Unit

  @JvmStatic
  public external fun ConnectionManager_set_remote_config(
    connectionManager: ObjectHandle,
    remoteConfig: ObjectHandle,
    buildVariant: Int,
  ): Unit
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun ConnectionProxyConfig_new(
    scheme: String,
    host: String,
    port: Int,
    username: String?,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun CreateCallLinkCredentialPresentation_Verify(
    presentationBytes: ByteArray,
    roomId: ByteArray,
    now: Long,
    serverParamsBytes: ByteArray,
  ...
  @JvmStatic
  public external fun CreateCallLinkCredentialRequestContext_NewDeterministic(
    roomId: ByteArray,
    randomness: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun CreateCallLinkCredentialRequestContext_ReceiveResponse(
    contextBytes: ByteArray,
    responseBytes: ByteArray,
    userId: ByteArray,
    paramsBytes: ByteArray,
  ...
  @JvmStatic
  public external fun CreateCallLinkCredentialRequest_IssueDeterministic(
    requestBytes: ByteArray,
    userId: ByteArray,
    timestamp: Long,
    paramsBytes: ByteArray,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun CreateCallLinkCredential_PresentDeterministic(
    credentialBytes: ByteArray,
    roomId: ByteArray,
    userId: ByteArray,
    serverParamsBytes: ByteArray,
  ...
  @JvmStatic
  public external fun CryptographicHash_Update(
    hash: ObjectHandle,
    input: ByteArray,
  ): Unit

  @JvmStatic
  public external fun CryptographicHash_UpdateWithOffset(
    hash: ObjectHandle,
    input: ByteArray,
    offset: Int,
    len: Int,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun CryptographicMac_New(
    algo: String,
    key: ByteArray,
  ): ObjectHandle

  @JvmStatic
  public external fun CryptographicMac_Update(
    mac: ObjectHandle,
    input: ByteArray,
  ): Unit

  @JvmStatic
  public external fun CryptographicMac_UpdateWithOffset(
    mac: ObjectHandle,
    input: ByteArray,
    offset: Int,
    len: Int,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun DecryptionErrorMessage_ForOriginalMessage(
  ...
  @JvmStatic
  public external fun DeleteBackupMediaStream_next(
    asyncRuntime: ObjectHandle,
    stream: SimpleOwner,
  ): CompletableFuture<Object>
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun DeviceTransfer_GenerateCertificate(
  ...
  @JvmStatic
  public external fun DonationPermitDerivedKeyPair_ForExpiration(
    timestamp: Long,
    root: SimpleOwner,
  ): ByteArray
  ...
  @JvmStatic
  public external fun DonationPermitRequestContext_NewDeterministic(
    count: Int,
    randomness: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun DonationPermitRequestContext_Receive(
    context: ByteArray,
    response: ByteArray,
    publicParams: SimpleOwner,
    now: Long,
  ): Array<ByteArray>
  ...
  @JvmStatic
  public external fun DonationPermitResponse_IssueDeterministic(
    request: ByteArray,
    keyPair: ByteArray,
    seed: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun DonationPermit_Verify(
    permit: ByteArray,
    now: Long,
    keyPair: ByteArray,
  ): Unit
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun ECPrivateKey_Agree(
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun ECPrivateKey_HpkeOpen(
    sk: ObjectHandle,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun ECPrivateKey_Sign(
    key: ObjectHandle,
    message: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun ECPublicKey_Deserialize(
    data: ByteArray,
    offset: Int,
    length: Int,
  ): ObjectHandle
  ...
  @JvmStatic
  public external fun ECPublicKey_Equals(
    lhs: ObjectHandle,
    rhs: ObjectHandle,
  ): Boolean
  ...
  @JvmStatic
  public external fun ECPublicKey_HpkeSeal(
    pk: ObjectHandle,
    plaintext: ByteArray,
    info: ByteArray,
    associatedData: ByteArray,
  ...
  @JvmStatic
  public external fun ECPublicKey_Verify(
    key: ObjectHandle,
    message: ByteArray,
    signature: ByteArray,
  ): Boolean
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun GroupCipher_DecryptMessage(
    sender: ObjectHandle,
    message: ByteArray,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun GroupCipher_EncryptMessage(
    sender: ObjectHandle,
    distributionId: UUID,
    message: ByteArray,
    store: SenderKeyStore,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun GroupSecretParams_DecryptBlobWithPadding(
    params: ByteArray,
    ciphertext: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun GroupSecretParams_DecryptProfileKey(
    params: ByteArray,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun GroupSecretParams_DecryptServiceId(
    params: ByteArray,
    ciphertext: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  public external fun GroupSecretParams_EncryptBlobWithPaddingDeterministic(
    params: ByteArray,
    randomness: ByteArray,
    plaintext: ByteArray,
    paddingLen: Int,
  ...
  @JvmStatic
  public external fun GroupSecretParams_EncryptProfileKey(
    params: ByteArray,
    profileKey: ByteArray,
    userId: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  public external fun GroupSecretParams_EncryptServiceId(
    params: ByteArray,
    serviceId: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  public external fun GroupSendDerivedKeyPair_ForExpiration(
    expiration: Long,
    serverParams: ObjectHandle,
  ): ByteArray

  @JvmStatic
  public external fun GroupSendEndorsement_CallLinkParams_ToToken(
    endorsement: ByteArray,
    callLinkSecretParamsSerialized: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  public external fun GroupSendEndorsement_Remove(
    endorsement: ByteArray,
    toRemove: ByteArray,
  ): ByteArray

  @JvmStatic
  public external fun GroupSendEndorsement_ToToken(
    endorsement: ByteArray,
    groupParams: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  public external fun GroupSendEndorsementsResponse_IssueDeterministic(
    concatenatedGroupMemberCiphertexts: ByteArray,
    keyPair: ByteArray,
    randomness: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun GroupSendEndorsementsResponse_ReceiveAndCombineWithCiphertexts(
    responseBytes: ByteArray,
    concatenatedGroupMemberCiphertexts: ByteArray,
    localUserCiphertext: ByteArray,
    now: Long,
    serverParams: ObjectHandle,
  ): Array<ByteArray>
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun GroupSendEndorsementsResponse_ReceiveAndCombineWithServiceIds(
    responseBytes: ByteArray,
    groupMembers: ByteArray,
    localUser: ByteArray,
    now: Long,
    groupParams: ByteArray,
    serverParams: ObjectHandle,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun GroupSendFullToken_Verify(
    token: ByteArray,
    userIds: ByteArray,
    now: Long,
    keyPair: ByteArray,
  ...
  @JvmStatic
  public external fun GroupSendToken_ToFullToken(
    token: ByteArray,
    expiration: Long,
  ): ByteArray
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun GroupSessionBuilder_CreateSenderKeyDistributionMessage(
    sender: ObjectHandle,
    distributionId: UUID,
    store: SenderKeyStore,
  ): ObjectHandle
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun GroupSessionBuilder_ProcessSenderKeyDistributionMessage(
    sender: ObjectHandle,
    senderKeyDistributionMessage: ObjectHandle,
    store: SenderKeyStore,
  ): Unit

  @JvmStatic
  @Throws(Exception::class)
  public external fun HKDF_DeriveSecrets(
    outputLength: Int,
    ikm: ByteArray,
    label: ByteArray?,
    salt: ByteArray?,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun HsmEnclaveClient_CompleteHandshake(
    cli: ObjectHandle,
    handshakeReceived: ByteArray,
  ): Unit
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun HsmEnclaveClient_EstablishedRecv(
    cli: ObjectHandle,
    receivedCiphertext: ByteArray,
  ): ByteArray

  @JvmStatic
  @Throws(Exception::class)
  public external fun HsmEnclaveClient_EstablishedSend(
    cli: ObjectHandle,
    plaintextToSend: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun HsmEnclaveClient_New(
    trustedPublicKey: ByteArray,
    trustedCodeHashes: ByteArray,
  ): ObjectHandle
  ...
  @JvmStatic
  public external fun HttpRequest_add_header(
    request: ObjectHandle,
    name: String,
    value: String,
  ): Unit
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun HttpRequest_new(
    method: String,
    path: String,
    bodyAsSlice: ByteArray?,
  ): ObjectHandle
  ...
  @JvmStatic
  public external fun IdentityKeyPair_Serialize(
    publicKey: ObjectHandle,
    privateKey: ObjectHandle,
  ): ByteArray
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun IdentityKeyPair_SignAlternateIdentity(
    publicKey: ObjectHandle,
    privateKey: ObjectHandle,
    otherIdentity: ObjectHandle,
  ): ByteArray

  @JvmStatic
  @Throws(Exception::class)
  public external fun IdentityKey_VerifyAlternateIdentity(
    publicKey: ObjectHandle,
    otherIdentity: ObjectHandle,
    signature: ByteArray,
  ): Boolean
  ...
  @JvmStatic
  public external fun IncrementalMac_Initialize(
    key: ByteArray,
    chunkSize: Int,
  ): ObjectHandle

  @JvmStatic
  public external fun IncrementalMac_Update(
    mac: ObjectHandle,
    bytes: ByteArray,
    offset: Int,
    length: Int,
  ...
  @JvmStatic
  public external fun KeyTransparency_Check(
    asyncRuntime: ObjectHandle,
    environment: Int,
    chatConnection: ObjectHandle,
    aci: ByteArray,
    aciIdentityKey: ObjectHandle,
    e164: String?,
    ...
    isSelfCheck: Boolean,
    isE164Discoverable: Boolean,
  ): CompletableFuture<Pair<ByteArray, ByteArray>>

  @JvmStatic
  public external fun KeyTransparency_E164SearchKey(e164: String): ByteArray

  @JvmStatic
  public external fun KeyTransparency_ResetDataField(
    accountData: ByteArray,
    field: Int,
  ): ByteArray
  ...
  @JvmStatic
  public external fun KyberPreKeyRecord_New(
    id: Int,
    timestamp: Long,
    keyPair: ObjectHandle,
    signature: ByteArray,
  ): ObjectHandle

  @JvmStatic
  @Throws(Exception::class)
  public external fun KyberPublicKey_DeserializeWithOffsetLength(
    data: ByteArray,
    offset: Int,
    length: Int,
  ): ObjectHandle
  ...
  @JvmStatic
  public external fun KyberPublicKey_Equals(
    lhs: ObjectHandle,
    rhs: ObjectHandle,
  ): Boolean
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun LookupRequest_addAciAndAccessKey(
    request: ObjectHandle,
    aci: ByteArray,
    accessKey: ByteArray,
  ): Unit
  ...
  @JvmStatic
  public external fun LookupRequest_addE164(
    request: ObjectHandle,
    e164: String,
  ): Unit

  @JvmStatic
  public external fun LookupRequest_addPreviousE164(
    request: ObjectHandle,
    e164: String,
  ): Unit
  ...
  @JvmStatic
  public external fun LookupRequest_setToken(
    request: ObjectHandle,
    token: ByteArray,
  ): Unit
  ...
  @JvmStatic
  public external fun MessageBackupKey_FromAccountEntropyPool(
    accountEntropy: String,
    aci: ByteArray,
    forwardSecrecyToken: ByteArray?,
  ): ObjectHandle

  @JvmStatic
  public external fun MessageBackupKey_FromBackupKeyAndBackupId(
    backupKey: ByteArray,
    backupId: ByteArray,
    forwardSecrecyToken: ByteArray?,
  ): ObjectHandle
  ...
  @JvmStatic
  public external fun MessageBackupKey_FromParts(
    hmacKey: ByteArray,
    aesKey: ByteArray,
  ): ObjectHandle
  ...
  public external fun MessageBackupValidator_Validate(
    key: ObjectHandle,
    firstStream: InputStream,
    secondStream: InputStream,
    len: Long,
    purpose: Int,
  ): Object
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun Mp4Sanitizer_Sanitize(
    input: InputStream,
    len: Long,
  ): ObjectHandle
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun Mp4Sanitizer_Sanitize_File_With_Compounded_MDAT_Boxes(
    input: InputStream,
    len: Long,
    cumulativeMdatBoxSize: Int,
  ): ObjectHandle
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun NumericFingerprintGenerator_New(
    iterations: Int,
    version: Int,
    localIdentifier: ByteArray,
    localKey: ObjectHandle,
    remoteIdentifier: ByteArray,
    remoteKey: ObjectHandle,
  ): ObjectHandle

  @JvmStatic
  @Throws(Exception::class)
  public external fun OnlineBackupValidator_AddFrame(
    backup: ObjectHandle,
    frame: ByteArray,
  ): Unit
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun OnlineBackupValidator_New(
    backupInfoFrame: ByteArray,
    purpose: Int,
  ): ObjectHandle
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun PinHash_FromSalt(
    pin: ByteArray,
    salt: ByteArray,
  ): ObjectHandle
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun PinHash_FromUsernameMrenclave(
    pin: ByteArray,
    username: String,
    mrenclave: ByteArray,
  ): ObjectHandle
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun Pin_VerifyLocalHash(
    encodedHash: String,
    pin: ByteArray,
  ): Boolean
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun PreKeyBundle_New(
    registrationId: Int,
    deviceId: Int,
    prekeyId: Int,
    prekey: ObjectHandle,
    signedPrekeyId: Int,
    signedPrekey: ObjectHandle,
    signedPrekeySignature: ByteArray,
    identityKey: ObjectHandle,
    kyberPrekeyId: Int,
    kyberPrekey: ObjectHandle,
  ...
  @JvmStatic
  public external fun PreKeyRecord_New(
    id: Int,
    pubKey: ObjectHandle,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun PreKeySignalMessage_New(
    messageVersion: Int,
    registrationId: Int,
    preKeyId: Int,
    signedPreKeyId: Int,
    baseKey: ObjectHandle,
    identityKey: ObjectHandle,
    signalMessage: ObjectHandle,
  ): ObjectHandle
  ...
  @JvmStatic
  public external fun ProfileKeyCredentialPresentation_GetStructurallyValidV1PresentationBytes(
    presentationBytes: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  public external fun ProfileKey_GetCommitment(
    profileKey: ByteArray,
    userId: ByteArray,
  ): ByteArray

  @JvmStatic
  public external fun ProfileKey_GetProfileKeyVersion(
    profileKey: ByteArray,
    userId: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun ProtocolAddress_New(
    name: String,
    deviceId: Int,
  ): ObjectHandle
  ...
  @JvmStatic
  public external fun ProvisioningChatConnection_connect(
    asyncRuntime: ObjectHandle,
    connectionManager: ObjectHandle,
  ): CompletableFuture<ObjectHandle>

  @JvmStatic
  public external fun ProvisioningChatConnection_disconnect(
    asyncRuntime: ObjectHandle,
    chat: ObjectHandle,
  ): CompletableFuture<Void?>

  @JvmStatic
  public external fun ProvisioningChatConnection_init_listener(
    chat: ObjectHandle,
  ...
  @JvmStatic
  public external fun RegisterAccountRequest_SetAccountPassword(
    registerAccount: ObjectHandle,
    accountPassword: String,
  ): Unit

  @JvmStatic
  public external fun RegisterAccountRequest_SetGcmPushToken(
    registerAccount: ObjectHandle,
    gcmPushToken: String,
  ): Unit

  @JvmStatic
  public external fun RegisterAccountRequest_SetIdentityPqLastResortPreKey(
    registerAccount: ObjectHandle,
    identityType: Int,
  ...
  @JvmStatic
  public external fun RegisterAccountRequest_SetIdentityPublicKey(
    registerAccount: ObjectHandle,
    identityType: Int,
    identityKey: ObjectHandle,
  ): Unit
  ...
  @JvmStatic
  public external fun RegisterAccountRequest_SetIdentitySignedPreKey(
    registerAccount: ObjectHandle,
    identityType: Int,
  ...
  @JvmStatic
  public external fun RegistrationAccountAttributes_Create(
    recoveryPassword: ByteArray,
  ...
  @JvmStatic
  public external fun RegistrationService_CheckSvr2Credentials(
    asyncRuntime: ObjectHandle,
    service: ObjectHandle,
    svrTokens: Array<Object>,
  ): CompletableFuture<Map<*, *>>

  @JvmStatic
  public external fun RegistrationService_CreateSession(
    asyncRuntime: ObjectHandle,
  ...
  @JvmStatic
  public external fun RegistrationService_RegisterAccount(
    asyncRuntime: ObjectHandle,
    service: ObjectHandle,
    registerAccount: ObjectHandle,
  ...
  @JvmStatic
  public external fun RegistrationService_RequestPushChallenge(
    asyncRuntime: ObjectHandle,
    service: ObjectHandle,
    pushToken: String,
  ): CompletableFuture<Void?>
  ...
  @JvmStatic
  public external fun RegistrationService_RequestVerificationCode(
    asyncRuntime: ObjectHandle,
    service: ObjectHandle,
    transport: String,
    client: String,
  ...
  @JvmStatic
  public external fun RegistrationService_ReregisterAccount(
    asyncRuntime: ObjectHandle,
    connectChat: ConnectChatBridge,
    number: String,
    registerAccount: ObjectHandle,
  ...
  @JvmStatic
  public external fun RegistrationService_ResumeSession(
    asyncRuntime: ObjectHandle,
    sessionId: String,
    number: String,
    connectChat: ConnectChatBridge,
  ...
  @JvmStatic
  public external fun RegistrationService_SubmitCaptcha(
    asyncRuntime: ObjectHandle,
    service: ObjectHandle,
    captchaValue: String,
  ): CompletableFuture<Void?>
  ...
  @JvmStatic
  public external fun RegistrationService_SubmitPushChallenge(
    asyncRuntime: ObjectHandle,
    service: ObjectHandle,
  ...
  @JvmStatic
  public external fun RegistrationService_SubmitVerificationCode(
    asyncRuntime: ObjectHandle,
    service: ObjectHandle,
    code: String,
  ): CompletableFuture<Void?>
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun ScannableFingerprint_Compare(
    fprint1: ByteArray,
    fprint2: ByteArray,
  ): Boolean
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun SealedSessionCipher_DecryptToUsmc(
    ctext: ByteArray,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun SealedSessionCipher_Encrypt(
    destination: ObjectHandle,
    content: ObjectHandle,
    identityKeyStore: IdentityKeyStore,
  ): ByteArray

  @JvmStatic
  @Throws(Exception::class)
  public external fun SealedSessionCipher_MultiRecipientEncrypt(
    recipients: LongArray,
    recipientSessions: LongArray,
    excludedRecipients: ByteArray,
    content: ObjectHandle,
    identityKeyStore: IdentityKeyStore,
  ): ByteArray
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun SealedSessionCipher_MultiRecipientMessageForSingleRecipient(
    encodedMultiRecipientMessage: ByteArray,
  ): ByteArray

  @JvmStatic
  public external fun SecureValueRecoveryForBackups_CreateNewBackupChain(
    environment: Int,
    backupKey: ByteArray,
  ): ByteArray

  @JvmStatic
  public external fun SecureValueRecoveryForBackups_RemoveBackup(
    asyncRuntime: ObjectHandle,
    connectionManager: ObjectHandle,
    username: String,
    password: String,
  ...
  @JvmStatic
  public external fun SecureValueRecoveryForBackups_RestoreBackupFromServer(
    asyncRuntime: ObjectHandle,
    backupKey: ByteArray,
    metadata: ByteArray,
    connectionManager: ObjectHandle,
  ...
  @JvmStatic
  public external fun SecureValueRecoveryForBackups_StoreBackup(
    asyncRuntime: ObjectHandle,
    backupKey: ByteArray,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun SenderCertificate_New(
    senderUuid: String,
    senderE164: String?,
    senderDeviceId: Int,
    senderKey: ObjectHandle,
    expiration: Long,
    signerCert: ObjectHandle,
    signerKey: ObjectHandle,
  ): ObjectHandle

  @JvmStatic
  public external fun SenderCertificate_Validate(
    cert: ObjectHandle,
    trustRoots: LongArray,
    time: Long,
  ): Boolean
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun SenderKeyDistributionMessage_New(
    messageVersion: Int,
    distributionId: UUID,
    chainId: Int,
    iteration: Int,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun SenderKeyMessage_New(
    messageVersion: Int,
    distributionId: UUID,
    chainId: Int,
    iteration: Int,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun SenderKeyMessage_VerifySignature(
    skm: ObjectHandle,
    pubkey: ObjectHandle,
  ): Boolean
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun ServerCertificate_New(
    keyId: Int,
    serverKey: ObjectHandle,
    trustRoot: ObjectHandle,
  ): ObjectHandle
  ...
  @JvmStatic
  public external fun ServerPublicParams_CreateAuthCredentialWithPniPresentationDeterministic(
    serverPublicParams: ObjectHandle,
    randomness: ByteArray,
    groupSecretParams: ByteArray,
    authCredentialWithPniBytes: ByteArray,
  ): ByteArray

  @JvmStatic
  public external fun ServerPublicParams_CreateExpiringProfileKeyCredentialPresentationDeterministic(
    serverPublicParams: ObjectHandle,
    randomness: ByteArray,
    groupSecretParams: ByteArray,
    profileKeyCredential: ByteArray,
  ): ByteArray

  @JvmStatic
  public external fun ServerPublicParams_CreateProfileKeyCredentialRequestContextDeterministic(
    serverPublicParams: ObjectHandle,
    randomness: ByteArray,
    userId: ByteArray,
    profileKey: ByteArray,
  ...
  @JvmStatic
  public external fun ServerPublicParams_CreateReceiptCredentialPresentationDeterministic(
    serverPublicParams: ObjectHandle,
    randomness: ByteArray,
    receiptCredential: ByteArray,
  ): ByteArray

  @JvmStatic
  public external fun ServerPublicParams_CreateReceiptCredentialRequestContextDeterministic(
    serverPublicParams: ObjectHandle,
    randomness: ByteArray,
    receiptSerial: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun ServerPublicParams_ReceiveAuthCredentialWithPniAsServiceId(
    params: ObjectHandle,
    aci: ByteArray,
    pni: ByteArray,
    redemptionTime: Long,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun ServerPublicParams_ReceiveReceiptCredential(
    serverPublicParams: ObjectHandle,
    requestContext: ByteArray,
    response: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun ServerPublicParams_VerifySignature(
    serverPublicParams: ObjectHandle,
    message: ByteArray,
    notarySignature: ByteArray,
  ): Unit
  ...
  @JvmStatic
  public external fun ServerSecretParams_IssueAuthCredentialWithPniZkcDeterministic(
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun ServerSecretParams_IssueExpiringProfileKeyCredentialDeterministic(
    serverSecretParams: ObjectHandle,
    randomness: ByteArray,
    request: ByteArray,
    userId: ByteArray,
  ...
  @JvmStatic
  public external fun ServerSecretParams_IssueReceiptCredentialDeterministic(
    serverSecretParams: ObjectHandle,
    randomness: ByteArray,
    request: ByteArray,
    receiptExpirationTime: Long,
    receiptLevel: Long,
  ): ByteArray
  ...
  @JvmStatic
  public external fun ServerSecretParams_SignDeterministic(
    params: ObjectHandle,
    randomness: ByteArray,
    message: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun ServerSecretParams_VerifyAuthCredentialPresentation(
    serverSecretParams: ObjectHandle,
    groupPublicParams: ByteArray,
    presentationBytes: ByteArray,
    currentTimeInSeconds: Long,
  ): Unit
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun ServerSecretParams_VerifyProfileKeyCredentialPresentation(
    serverSecretParams: ObjectHandle,
    groupPublicParams: ByteArray,
    presentationBytes: ByteArray,
    currentTimeInSeconds: Long,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun ServerSecretParams_VerifyReceiptCredentialPresentation(
    serverSecretParams: ObjectHandle,
    presentation: ByteArray,
  ): Unit
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun SessionBuilder_ProcessPreKeyBundle(
    bundle: ObjectHandle,
    protocolAddress: ObjectHandle,
    localAddress: ObjectHandle,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun SessionCipher_DecryptPreKeySignalMessage(
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun SessionCipher_DecryptSignalMessage(
    message: ObjectHandle,
    protocolAddress: ObjectHandle,
    localAddress: ObjectHandle,
    sessionStore: SessionStore,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun SessionCipher_EncryptMessage(
    ptext: ByteArray,
    protocolAddress: ObjectHandle,
    localAddress: ObjectHandle,
    sessionStore: SessionStore,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun SessionRecord_CurrentRatchetKeyMatches(
    s: ObjectHandle,
    key: ObjectHandle,
  ): Boolean
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun SgxClientState_CompleteHandshake(
    cli: ObjectHandle,
    handshakeReceived: ByteArray,
  ): Unit
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun SgxClientState_EstablishedRecv(
    cli: ObjectHandle,
    receivedCiphertext: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun SgxClientState_EstablishedSend(
    cli: ObjectHandle,
    plaintextToSend: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun SignalMessage_New(
    messageVersion: Int,
    macKey: ByteArray,
    senderRatchetKey: ObjectHandle,
    counter: Int,
    previousCounter: Int,
    ciphertext: ByteArray,
    senderIdentityKey: ObjectHandle,
    receiverIdentityKey: ObjectHandle,
    pqRatchet: ByteArray,
  ): ObjectHandle
  ...
  @JvmStatic
  public external fun SignedPreKeyRecord_New(
    id: Int,
    timestamp: Long,
    pubKey: ObjectHandle,
    privKey: ObjectHandle,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun Svr2Client_New(
    mrenclave: ByteArray,
    attestationMsg: ByteArray,
    currentTimestamp: Long,
  ): ObjectHandle
  ...
  @JvmStatic
  public external fun TokioAsyncContext_cancel(
    context: ObjectHandle,
    rawCancellationId: Long,
  ): Unit
  ...
  @JvmStatic
  public external fun UnauthenticatedChatConnection_account_exists(
    asyncRuntime: ObjectHandle,
    chat: SimpleOwner,
    account: ByteArray,
  ...
  @JvmStatic
  public external fun UnauthenticatedChatConnection_backup_copy_media(
    chat: SimpleOwner,
  ...
  @JvmStatic
  public external fun UnauthenticatedChatConnection_backup_delete_all(
    asyncRuntime: ObjectHandle,
    chat: SimpleOwner,
    credential: ByteArray,
    serverKeys: ByteArray,
  ...
  @JvmStatic
  public external fun UnauthenticatedChatConnection_backup_delete_media(
    chat: SimpleOwner,
    credential: ByteArray,
    serverKeys: ByteArray,
    signingKey: SimpleOwner,
  ...
  @JvmStatic
  public external fun UnauthenticatedChatConnection_backup_get_cdn_credentials(
    asyncRuntime: ObjectHandle,
    chat: SimpleOwner,
    credential: ByteArray,
    serverKeys: ByteArray,
  ...
  @JvmStatic
  public external fun UnauthenticatedChatConnection_backup_get_media_backup_info(
    asyncRuntime: ObjectHandle,
    chat: SimpleOwner,
    credential: ByteArray,
    serverKeys: ByteArray,
  ...
  @JvmStatic
  public external fun UnauthenticatedChatConnection_backup_get_media_upload_form(
    asyncRuntime: ObjectHandle,
    chat: ObjectHandle,
    credential: ByteArray,
    serverKeys: ByteArray,
    signingKey: ObjectHandle,
    uploadSize: Long,
    rng: Long,
  ): CompletableFuture<Object>

  @JvmStatic
  public external fun UnauthenticatedChatConnection_backup_get_message_backup_info(
    asyncRuntime: ObjectHandle,
    chat: SimpleOwner,
    credential: ByteArray,
    serverKeys: ByteArray,
  ...
  @JvmStatic
  public external fun UnauthenticatedChatConnection_backup_get_svrb_credentials(
    asyncRuntime: ObjectHandle,
    chat: SimpleOwner,
    credential: ByteArray,
    serverKeys: ByteArray,
  ...
  @JvmStatic
  public external fun UnauthenticatedChatConnection_backup_get_upload_form(
    asyncRuntime: ObjectHandle,
    chat: ObjectHandle,
    credential: ByteArray,
    serverKeys: ByteArray,
  ...
  @JvmStatic
  public external fun UnauthenticatedChatConnection_backup_set_public_key(
    asyncRuntime: ObjectHandle,
    chat: SimpleOwner,
    credential: ByteArray,
    serverKeys: ByteArray,
  ...
  @JvmStatic
  public external fun UnauthenticatedChatConnection_get_pre_keys_access_key_auth(
    asyncRuntime: ObjectHandle,
    chat: ObjectHandle,
    auth: ByteArray,
    target: ByteArray,
  ...
  @JvmStatic
  public external fun UnauthenticatedChatConnection_get_pre_keys_group_auth(
    asyncRuntime: ObjectHandle,
    chat: ObjectHandle,
    auth: ByteArray,
    target: ByteArray,
  ...
  @JvmStatic
  public external fun UnauthenticatedChatConnection_get_pre_keys_unrestricted_auth(
    asyncRuntime: ObjectHandle,
    chat: ObjectHandle,
    target: ByteArray,
    device: Int,
  ...
  @JvmStatic
  public external fun UnauthenticatedChatConnection_init_listener(
    chat: ObjectHandle,
    listener: BridgeChatListener,
  ): Unit

  @JvmStatic
  public external fun UnauthenticatedChatConnection_look_up_username_hash(
    asyncRuntime: ObjectHandle,
    chat: ObjectHandle,
    hash: ByteArray,
  ): CompletableFuture<UUID?>
  ...
  @JvmStatic
  public external fun UnauthenticatedChatConnection_look_up_username_link(
    asyncRuntime: ObjectHandle,
    chat: ObjectHandle,
    uuid: UUID,
    entropy: ByteArray,
  ): CompletableFuture<Pair<String, ByteArray>?>

  @JvmStatic
  public external fun UnauthenticatedChatConnection_send(
    asyncRuntime: ObjectHandle,
    chat: ObjectHandle,
    httpRequest: ObjectHandle,
    timeoutMillis: Int,
  ...
  public external fun UnauthenticatedChatConnection_send_message(
    ...
    authKind: Int,
    authBuffer: ByteArray?,
    onlineOnly: Boolean,
    isUrgent: Boolean,
  ): CompletableFuture<Void?>

  @JvmStatic
  public external fun UnauthenticatedChatConnection_send_multi_recipient_message(
    asyncRuntime: ObjectHandle,
    chat: ObjectHandle,
    payload: ByteArray,
    timestamp: Long,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun UnidentifiedSenderMessageContent_New(
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun UsernameLink_Create(
    username: String,
    entropy: ByteArray?,
  ): ByteArray
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun UsernameLink_DecryptUsername(
    entropy: ByteArray,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun Username_CandidatesFrom(
    nickname: String,
    minLen: Int,
    maxLen: Int,
  ): Array<Object>
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun Username_HashFromParts(
    nickname: String,
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun Username_Proof(
    username: String,
    randomness: ByteArray,
  ): ByteArray
  ...
  @JvmStatic
  @Throws(Exception::class)
  public external fun Username_Verify(
    proof: ByteArray,
    hash: ByteArray,
  ): Unit
  ...
  @JvmStatic
  public external fun ValidatingMac_Initialize(
    key: ByteArray,
    chunkSize: Int,
    digests: ByteArray,
  ): ObjectHandle
  ...
  @JvmStatic
  public external fun ValidatingMac_Update(
    mac: ObjectHandle,
    bytes: ByteArray,
    offset: Int,
    length: Int,
  ...
  // Keep these definitions in sync with the native Rust code that manually implements them
  @JvmStatic
  public external fun initializeLibrary(): Unit

  @JvmStatic
  public external fun AsyncLoadClass(
    tokioContext: Object,
    className: String,
  ): Object

  @JvmStatic
  public external fun Logger_Initialize(
    maxLevel: Int,
    loggerClass: Class<*>,
  ): Unit
